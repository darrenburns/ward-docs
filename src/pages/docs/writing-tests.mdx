...
statement are replaced with a function call.

<Warning>As of `0.28.0b0`, assertion rewriting only applies to assertions of the form `assert x == y`, and to
assertions that appear directly in your tests.</Warning>
<br/>
