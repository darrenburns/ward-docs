...
Another pattern I've found useful is tagging tests with the 
name of the function or method they're testing so that I can easily
run all tests that test a specific method. For example "run all
tests that test the `MyCounter.increment` method":
