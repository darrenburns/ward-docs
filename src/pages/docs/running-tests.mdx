...
## Performing a dry run **<Red> (Proposal)</Red>**
...
tests themselves won't actually run. When using `--dry-run`, tests will return with an outcome of `DRYRUN`.

This is useful for determining which tests Ward *would* run if invoked normally.

Tracking proposal on GitHub: https://github.com/darrenburns/ward/issues/129
